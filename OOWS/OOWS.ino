...
class DallasTemp : public Sensor {
  ...
  public:
    ...
    String getValueName(int num) {
      return "DallasTemp_" + String(pin) + "_temperature";
    }
};
...
class BatterySensor : public Sensor {
  ...
  public:
    ...
    float getValue(int num) {
      ...
      float voltage = sensorValue * (5.00 / 1023.00) *2; //convert value to voltage
      return voltage;
    }

    String getValueName(int num) {
      return "batterySensor_pin_" + String(pin) + "_volts";
    }
  ...
  public:
   SHTSensor(int pin) {
    ...
    float getValue(int num) {
      switch (num) {
        case 0:
          return sht15.readTemperatureC();
        case 1:
          return sht15.readHumidity(); 
        default:
          return 0;
      }
    }
    ...
    String getValueName(int num) {
      switch (num) {
        case 0:
          return "SHT_pin_" + String(pin) + "_temperature";
        case 1:
          return "SHT_pin_" + String(pin) + "_humidity";
        default:
          return "";
      }
    }
...
class TippingBucket : public Sensor {
  ...
  public:
    ...
    String getValueName(int num) {
      return "tipping_bucket_pin_" + String(pin) + "_mb";
    }
};
...
class CustomDataServerOutput : public Output {
  public:
    CustomDataServerOutput() {
      sendHTTP(CUSTOM_DATA_SERVER_IP, 80, "GET /api/arduinos/" + ARDUINO_NAME + "/init", "X-Password: " + CUSTOM_DATA_SERVER_PASSWORD + "\n", "");
    }
    ...
    void outputData(String headers[], float data[], int dataLength) {
      ...
      sendHTTP(CUSTOM_DATA_SERVER_IP, 80, "POST /api/arduinos/" + ARDUINO_NAME + "/addData", "X-Password: " + CUSTOM_DATA_SERVER_PASSWORD + "\n", strData);
    }
};
...
class SDCardOutput : public Output {
  ...
  public:
    ...
    void outputData(String headers[], float data[], int dataLength) {
      ...
      file.print(rtc.getHour()*60+rtc.getSecond()); //TODO NEED TO CHANGE TO UNIX TIME
